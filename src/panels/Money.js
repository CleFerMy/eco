                        ...
                        <UI.PullToRefresh onRefresh={ () => { props.apiq( "main0" ) } } isFetching={ props.state.fetching }>
                            <div>
                                ...
                                <UI.Group title="Основной счёт">
                                    <UI.List>
                                        <UI.Cell multiline={true} before={ <UI.Avatar style={ { background: '#4BB34B' } } size={48}><Icon24Coins fill="#fff" /></UI.Avatar> } description={ props.state.money.c1 ? ( props.nl( props.state.money.c1 ) + props.dn( props.state.money.c1,[ ' единица',' единицы',' единиц' ] ) ) : 'Неизвестно' }>Ридий</UI.Cell>
